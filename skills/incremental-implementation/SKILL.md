...
Per-increment verification is the local check. Before declaring a task done, apply the project-wide Definition of Done as the final gate, the standing bar every increment clears regardless of the task. See `references/shared/definition-of-done.md`.


## Distribution and attribution

Distributed by Aiescu. Original author: Addy Osmani. Source: [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills/tree/be4e44a9fbc5e8df0beaefadbb28bd22ee61cc39/skills/incremental-implementation).
