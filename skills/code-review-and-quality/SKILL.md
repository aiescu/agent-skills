...
- For detailed security review guidance, see `references/shared/security-checklist.md`
- For performance review checks, see `references/shared/performance-checklist.md`
...
Distributed by Aiescu. Original author: Addy Osmani. Source: [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills/tree/be4e44a9fbc5e8df0beaefadbb28bd22ee61cc39/skills/code-review-and-quality).
