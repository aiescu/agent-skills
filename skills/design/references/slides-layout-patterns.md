...
python assets/support/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python assets/support/design-system/scripts/search-slides.py "traction slide" \
