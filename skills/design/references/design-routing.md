...
**Brand:**
```bash
node assets/support/brand/scripts/inject-brand-context.cjs
node assets/support/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node assets/support/design-system/scripts/generate-tokens.cjs -c tokens.json
node assets/support/design-system/scripts/validate-tokens.cjs -d src/
```
