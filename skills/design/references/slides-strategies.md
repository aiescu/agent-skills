...
python assets/support/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python assets/support/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
