...
- For the project-wide Definition of Done that every change must clear before this checklist, see `references/shared/definition-of-done.md`
- For security pre-launch checks, see `references/shared/security-checklist.md`
- For performance pre-launch checklist, see `references/shared/performance-checklist.md`
- For accessibility verification before launch, see `references/shared/accessibility-checklist.md`
...
Distributed by Aiescu. Original author: Addy Osmani. Source: [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills/tree/be4e44a9fbc5e8df0beaefadbb28bd22ee61cc39/skills/shipping-and-launch).
