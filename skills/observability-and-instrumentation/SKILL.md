...
For the at-a-glance version of this list, including the pre-launch instrumentation gate, see `references/shared/observability-checklist.md`.


## Distribution and attribution

Distributed by Aiescu. Original author: Addy Osmani. Source: [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills/tree/be4e44a9fbc5e8df0beaefadbb28bd22ee61cc39/skills/observability-and-instrumentation).
