...
[![Stars refreshed](https://img.shields.io/badge/stars_refreshed-2026-09-14-blue)](catalog/stars.json)
...
Sorted by stars as of 2026-09-14.

| # | Repository | Stars | What it is | Flagship skill | License |
|---|---|---:|---|---|---|
| 1 | [obra/superpowers](https://github.com/obra/superpowers) | 286.5k | An opinionated software-development methodology delivered as composable skills: brainstorm, plan, TDD, debug, review, ship | `brainstorming` | MIT |
| 2 | [mattpocock/skills](https://github.com/mattpocock/skills) | 261.7k | Small, composable engineering skills straight from Matt's .agents directory | `grill-with-docs` | MIT |
| 3 | [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | 212.9k | A single skill distilled from Karpathy's observations on LLM coding pitfalls: think first, simplicity, surgical changes, goal-driven execution | `karpathy-guidelines` | Unlicensed (README says MIT) |
| 4 | [anthropics/skills](https://github.com/anthropics/skills) | 176.2k | The official reference collection, the Agent Skills spec, and the skill template | `skill-creator` | Per-skill (Apache-2.0 / proprietary) |
| 5 | [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | 127.5k | Design intelligence for building professional UI across platforms: 192 reasoning rules, 79 searchable styles, a design-system generator | `ui-ux-pro-max` | MIT |
| 6 | [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | 105.5k | Cuts about 65% of output tokens by making the agent talk like a caveman while keeping technical accuracy | `caveman` | MIT (skills) / BSL-1.1 (engine, proxy) |
| 7 | [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) | 94.2k | Production-grade engineering skills organized as a lifecycle: define, plan, build, verify, review, ship | `spec-driven-development` | MIT |
| 8 | [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) | 87.0k | Gives your AI good taste: stops generic frontend slop with brief inference, variance/motion/density dials, and a design-system map | `design-taste-frontend` | MIT |
| 9 | [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | 75.0k | A curated awesome-list of about 180 skills plus 800+ app-automation skills for Composio's MCP gateway | `connect-apps` | Unlicensed (README says Apache-2.0) |
| 10 | [ayghri/i-have-adhd](https://github.com/ayghri/i-have-adhd) | 44.9k | Ten output rules that stop the agent burying the answer: lead with the next action, number steps, cap lists at five, no preamble | `i-have-adhd` | MIT |

## Each repo

### Superpowers ([obra/superpowers](https://github.com/obra/superpowers))

by [Jesse Vincent (obra)](https://github.com/obra) · ⭐ 286.5k · 14 skills · MIT
...
by [Matt Pocock](https://github.com/mattpocock) · ⭐ 261.7k · 37 skills · MIT
...
by [multica-ai (formerly forrestchang)](https://github.com/multica-ai) · ⭐ 212.9k · 1 skill · Unlicensed (README says MIT)
...
by [Anthropic](https://github.com/anthropics) · ⭐ 176.2k · 19 skills · Per-skill (Apache-2.0 / proprietary)
...
by [nextlevelbuilder](https://github.com/nextlevelbuilder) · ⭐ 127.5k · 7 skills · MIT
...
by [Julius Brussee](https://github.com/JuliusBrussee) · ⭐ 105.5k · 20 skills · MIT (skills) / BSL-1.1 (engine, proxy)
...
by [Addy Osmani](https://github.com/addyosmani) · ⭐ 94.2k · 25 skills · MIT
...
by [Leonxlnx](https://github.com/Leonxlnx) · ⭐ 87.0k · 13 skills · MIT
...
by [Composio](https://github.com/ComposioHQ) · ⭐ 75.0k · 865 skills · Unlicensed (README says Apache-2.0)
...
by [ayghri](https://github.com/ayghri) · ⭐ 44.9k · 1 skill · MIT
